...
public class SearchDeviceActivity extends MyListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SamplesUtils.indeterminate(SearchDeviceActivity.this, _handler,getResources().getString(R.string.scaning), _discoveryWorkder, new OnDismissListener() {
	...
	private Runnable _discoveryWorkder = new Runnable() {
		public void run() {
			...
			Log.d("IHUL", "Procurando doidao");
			for (;;) {
				if (_discoveryFinished) {
					Log.d("IHUL", "Achei cumpadi");
					break;
				}
				try {
					Thread.sleep(100);
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		Log.d(Application.TAG, "Pega um ae");
